...
{
	document.getElementById(element.name).style = "display: block; z-index:100000000000000000000000000000000000000000 !important;";
	document.getElementById("close-"+element.name).style = "display: block; z-index:100000000000000000000000000000000000000000 !important;";
}
